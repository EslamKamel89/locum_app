...
import 'package:locum_app/features/common_data/cubits/districts_data/districts_data_cubit.dart';
...
class _UserDoctorFormState extends State<UserDoctorForm> {
  ...
  late UserDoctorCubit controller;
  ...
  void initState() {
    ...
    controller = context.read<UserDoctorCubit>();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<UserDoctorCubit, UserDoctorState>(
