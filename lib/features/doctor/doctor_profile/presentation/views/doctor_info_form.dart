...
class DoctorInfoFormState extends State<DoctorInfoForm> {
  ...
  void _initializeTextFieldIfUpdating() {
    ...
    _licenseIssueDateController.text = formatStrDateToAmerican(doctorInfoModel?.licenseIssueDate) ?? '';
    _licenseExpireDateController.text = formatStrDateToAmerican(doctorInfoModel?.licenseExpiryDate) ?? '';
  }
}
