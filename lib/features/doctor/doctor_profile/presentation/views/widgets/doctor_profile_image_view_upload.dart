...
class DoctorProfileImageUploadView extends StatefulWidget {
  const DoctorProfileImageUploadView(
      {super.key, required this.onImageSelected});
  final Function(File file) onImageSelected;

  @override
  State<DoctorProfileImageUploadView> createState() =>
      _DoctorProfileImageUploadViewState();
}

class _DoctorProfileImageUploadViewState
    extends State<DoctorProfileImageUploadView> {
