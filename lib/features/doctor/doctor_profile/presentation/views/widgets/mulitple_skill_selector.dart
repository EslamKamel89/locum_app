...
class MuiltipleValueSkillSelector extends StatefulWidget {
  ...
  @override
  State<MuiltipleValueSkillSelector> createState() =>
      _MuiltipleValueSkillSelectorState();
}

class _MuiltipleValueSkillSelectorState
    extends State<MuiltipleValueSkillSelector> {
  ...
  void initState() {
    ...
    selectedSkills =
        (doctorModel?.skills ?? []).map((skill) => skill.name ?? '').toList();
