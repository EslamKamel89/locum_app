...
import 'package:locum_app/features/doctor/messages/domain/models/message_card_model.dart';
...
class _MessagesViewState extends State<MessagesView> {
  ...
  Future _initState() async {
    ...
    totalUnseenCount = controller.state.messageCards?.isNotEmpty == true
            ...
            title: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: state.responseType == ResponseEnum.loading
                      ? Container(
                          height: 18.h,
                          width: 18.h,
