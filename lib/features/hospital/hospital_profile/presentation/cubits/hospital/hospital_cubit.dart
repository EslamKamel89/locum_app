...
class HospitalCubit extends Cubit<HospitalState> {
  ...
  Future updateOrCreateHospital({required HospitalParams params, required bool create, int? id}) async {
    ...
    result.fold(
      ...
      (HospitalModel hospitalModel) async {
        ...
        emit(state.copyWith(hospitalModel: hospitalModel, responseType: ResponseEnum.success, errorMessage: null));
      },
    );
  }
