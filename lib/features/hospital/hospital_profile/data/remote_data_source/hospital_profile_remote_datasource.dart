...
class HospitalProfileRemoteDatasource {
  ...
  HospitalProfileRemoteDatasource({
    required this.api,
  });
  ...
  Future<HospitalInfoModel> updateOrCreateHospitalInfo({
    ...
    final t =
        prt('updateOrCreateHospitalInfo - HospitalProfileRemoteDatasource');
    ...
    final data = await api.post(
      EndPoint.hospitalInfoCreateOrUpdate,
      data: requestData,
    );
    HospitalInfoModel hospitalInfoModel =
        HospitalInfoModel.fromJson(data['data']);
